...
private:
    ...
    int fork_exec(int argc, char **argv, char **envp);

public:
    Command(int in_fd, int out_fd, int err_fd, bool background, int argc, char **argv, char **envp, std::map<std::string, builtin> builtins_map);
